...
<body>
			...
			<div class="container col-lg-7 col-sm-12 border rounded ">
				...
				<div >
					...
					<div class="container col-7 display-4 ">
						<strong> <%out.print(art.getNomArticle());%></strong>
					</div>
				...
				<div class="container col-7">
					<div class="row">
						...
						<form action="profil" method="post">
							<button style="margin-top: 5px; margin-left: -5px;" name="profil"
								class="btn btn-link" value="<%=art.getNoUtilisateur()%>"
								type="submit">
								<%
						...
						<div class="row" style="margin-top: 10px;">
							...
							<p>
								...
								<input class="form-control" type="number"
									style="width: 100px; margin-top: -4px; margin-left: 15px;"
									name="enchere"
									min=<%if (art.getPrixVente() == 0)
				out.print(art.getPrixInitial());
			else
				out.print(art.getPrixVente());%>
						...
						<button type="submit" class="btn btn-outline-primary mb-2"
							style="margin-top: -90px; margin-left: 225px;" name="noArticle"
							value=<%out.print(art.getNoArticle());%>>Enchérir</button>
					</form>
				</div>

				<%
															if (null != user && art.getNoUtilisateur() == user.getNo_utilisateur()
																	&& art.getEtat().equalsIgnoreCase("PR")) {
														%>
				<div class="btn-group">
	...
	<a href="index" class="btn btn-primary btn-block mx-auto"
		style="width: 10em; margin-top: 10px;">Page principal</a>
	</div>
</body>
</html>