...
<div class="container-fluid" style="margin-top: 1%; margin-bottom: 2%;">
	...
	<div class="row d-flex justify-content-between">
		...
		session = request.getSession();
		%>
		<a class="navbar-brand col-3" href="index" style="margin-left: 2%">
		...
		<div
			class="col-lg-3 col-sm-5 d-flex flex-column justify-content-center">
			<a href="login" class="m-auto"> <img
				src="images/picto_eniEnchere.png" width="40">
			</a> <a href="login" class="m-auto">S'inscrire / Se connecter</a>
		</div>
